...
- [handoff/index.md](handoff/index.md) — how IBM Bob executes the plan: durable per-phase prompts, progress tracker, orchestration + adversarial review
- [impl/index.md](impl/index.md) — implementation notes, architecture-as-built
- [reference/index.md](reference/index.md) — cached Context7/library patterns & API snippets (version+date stamped)
- [conventions/index.md](conventions/index.md) — how we work together: workflow & interaction preferences
